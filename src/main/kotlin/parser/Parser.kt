...
private fun upcateFirstChar(key: String): String {
...
private fun checkIsString (item: JsonElement):Boolean {
    return item.isJsonPrimitive && item.asJsonPrimitive.isString
}
private fun checkIsNumber (item: JsonElement):Boolean {
    return item.isJsonPrimitive && item.asJsonPrimitive.isNumber
}
private fun checkIsBoolean (item: JsonElement):Boolean {
...
private fun detectMultiArrayTypes(value: JsonElement, valueType: MutableList<String> = mutableListOf<String>()): MutableList<String> {
